                                            ...
                                            <form class="dotables" onsubmit="return submitform();"
                                                ...
                                                <table class="table table-bordered" width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" id="remark" name="sellnumber"
                                                                   value="<?php echo $sellnumber ?>" readonly>
                                                        </td>
                                                        <td>销售者</td>
                                                        <td><input type="text"
                                                                   value="<?php echo $this->account_info_lib->accountname ?>"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>折扣总价(RMB)</td>
                                                        <td><input type="text" value="<?php echo $sell[0]->discount ?>"
                                                                   onkeypress="return isfloat(event)"
                                                                   name="discount" required></td>
                                                    </tr>
                                                    <tr>
                                                        <td>已付金额(RMB)</td>
                                                        <td><input type="text" value="<?php echo $sell[0]->paymoney ?>"
                                                                   name="paymoney" onkeypress="return isfloat(event)" required></td>
                                                        <td>未付金额(RMB)</td>
                                                        <td><input type="text" value="<?php echo $sell[0]->lastmoney ?>"
                                                    ...
                                                    <tr>
                                                        <td>客户名称</td>
                                                        <td><input type="text"
                                                                   value="<?php echo $sell[0]->clientname ?>"
                                                                   placeholder="请输入客户名称" name="clientname">
                                                        </td>
                                                        <td>客户电话</td>
                                                        <td><input type="text"
                                                                   value="<?php echo $sell[0]->clientphone ?>"
...
//                list.push('<td class="table-textcenter">' + item.code + '</td>');
//                list.push('<td class="table-textcenter">' + item.barcode + '</td>');
//                list.push('<td class="table-textcenter">' + item.factoryname + '</td>');
//                list.push('<td class="table-textcenter">' + item.memo + '</td>');
...
function returnContent() {
    josnData = <?php echo json_encode($list);?>;
    $.each(josnData, function (i, item) {
        addProToBill(item.id);
    })
}
