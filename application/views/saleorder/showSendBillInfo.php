            ...
            <div class="row">
                ...
                <div class="span9">
                    <h1 class="page-title"><i class="icon-th-list"></i> <a
                            href="<?php echo site_url('saleorder/orderList') ?>"
                    ...
                    <div class="row">
                        <div class="span9 doconfirm"><label class="pull-right">
                                ...
                                <a class="btn btn-primary" name="doback"
                                   href="<?php echo site_url('saleorder/showInfo?id=').$sell->id ?>"> 返回 </a> </label></div>
                    </div>
                    <div class="row">
                        <div class="span9">
                            <div class="widget">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="1">
                                                <table class="table table-bordered" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>客户地址</td>
                                                        <td colspan="3"><?php echo $sell->clientadd;?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>备注</td>
