        ...
        bootbox.confirm(msg, function(result) {
            if(result){
                ...
                $.ajax({
                    type:"post",
                    data: "id=" + str,
                    url:"<?php echo site_url('optlog/doSdataDel')?>",
...
<div class="span9">
    <h1 class="page-title">
        ...
        <a href="<?php echo site_url('users/sDataList') ?>" class="path-menu-a"> 系统设置</a> >  操作日志管理
    </h1>
    <div class="row">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row->operatetime ?></td>
                        <td><?php echo $row->operatecontent ?></td>
                    </tr>
