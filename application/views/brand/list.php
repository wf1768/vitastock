        ...
        bootbox.confirm(msg, function(result) {
            if(result){
                ...
                $.ajax({
                    type:"post",
                    data: "id=" + str,
                    url:"<?php echo site_url('brand/doBrandDel')?>",
...
<div class="span9">
    <h1 class="page-title">
        ...
        <a href="<?php echo site_url('users/sDataList') ?>" class="path-menu-a"> 系统设置</a> > 品牌管理
    </h1>
    <div class="row">
        <div class="span9 doconfirm">
            <label class="pull-right">
                ...
                <a href="javascript:;" class="btn btn-small" onclick="remove_brand()">
