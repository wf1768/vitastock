...
<div class="span9">
    <h1 class="page-title">
        ...
        <a href="<?php echo site_url('users/sDataList') ?>" class="path-menu-a"> 系统设置</a> > <a href="<?php echo site_url('users/sDataList') ?>" class="path-menu-a"> 用户管理</a> > 添加
    </h1>
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            ...
                            <input  type="hidden" id="path" value="<?php echo site_url('') ?>">
                                <form id="forms"  method="post" class="form-horizontal" action="<?php echo site_url("users/doSdataAdd")?>" >
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="accountcode" placeholder="登陆名"  check-type="required" required-message="用户名称不能为空！" >
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="accountname" placeholder="真实姓名"  check-type="required" required-message="登陆名不能为空！" >
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        <!-- /control-group -->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text"  class="span3"  required id="inputEmail" check-type="mail" name="email" placeholder="邮箱" mail-message="邮箱格式不正确！" >
                                        ...
                                        <!-- /control-group -->
                                        <div class="control-group">
                                            <label class="control-label" for="remark">登陆密码</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="phone" placeholder="电话"  >
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        <!-- /control-group -->
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="mobilephone" placeholder="手机" >
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        <!-- /control-group -->
                                                ...
                                                <select name="orgid"  class="span3" >
                                                 <option  value="0">顶级分组</option>
                                                    <?php foreach($group as $val):?>
                                                      <option  value="<?php echo $val->id?>" <?php if($val->id==$norgid) echo "selected"?>><?php echo $val->orgcode;?> </option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                            <!-- /controls -->
                                        ...
                                        <div class="form-actions">
                                           <input type="submit" id="doadds" class="btn btn-primary " value="添加数据">
                                        </div>
                                        <!-- /form-actions -->
                                    </fieldset>
                                </form>
