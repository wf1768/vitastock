        ...
        <div class="row">
            ...
            <div class="span9">
                <h1 class="page-title">
                    ...
                    <a href="<?php echo site_url('notice/sDataList') ?>" class="path-menu-a">消息管理</a> > <a
                        href="<?php echo site_url('color/sDataList') ?>" class="path-menu-a"> 消息管理</a> > 添加
                </h1>
                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="1">
                                            ...
                                            <form method="post" class="form-horizontal" id="mfrom"
                                                  action="<?php echo site_url("notice/doSdataAdd") ?>">
                                                <fieldset>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="span3" id="titles" name="title"
                                                                   placeholder="消息名称" required>
                                                        </div>
                                                        <!-- /controls -->
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name="content" class="span4" placeholder="消息内容"
                                                                      id="contents" rows="9" cols="70" required>
                                                            </textarea>
                                                        </div>
                                                        <!-- /controls -->
                                                    </div>
                                                    ...
                                                    <div class="form-actions">
                                                        <input type="button" id="dosubmit" class="btn btn-primary "
                                                               value="保存数据">
                                                    </div>
                                                    <!-- /form-actions -->
                                                </fieldset>
