        ...
        <div class="row">
            ...
            <div class="span9">
                <h1 class="page-title">
                    ...
                    <a href="<?php echo site_url('stock') ?>" class="path-menu-a"> 库存管理</a> > <a href="<?php echo site_url('storehouse_in') ?>" class="path-menu-a"> 入库单管理</a> > 浏览入库商品
                </h1>
                <div class="widget widget-table">
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?php echo site_url('storehouse_in/show?id='.$storehouseid) ?>"
                           class="btn">返回</a>
                    </div>
                </div>
            </div>
