        ...
        bootbox.confirm(msg, function(result) {
            if(result){
                ...
                $.ajax({
                    type:"post",
                    data: "id=" + str,
                    url:"<?php echo site_url('org/doSdataDel')?>",
...
<div class="span9">
    <h1 class="page-title">
        ...
        <a href="<?php echo site_url('users/sDataList') ?>" class="path-menu-a"> 系统设置</a> >  分组管理
    </h1>
    <div class="row">
        <div class="span9 doconfirm">
            <label class="pull-right">
                <input type="hidden" id="path" value="<?php echo site_url('') ?>">
                <a href="<?php echo site_url("org/sDataAdd")?>" id="add" class="btn btn-small">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row->orgmemo ?></td>
                        <td><?php org::getRole($row->roleid); ?></td>  
                        <td><?php org::getStroe($row->store)  ?></td>
                        <td><a href="<?php echo site_url("org/sDataEdit?id=".$row->id)?>" class="btn btn-primary">修改数据</a> </td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
            </table>
