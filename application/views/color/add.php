                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            ...
                            <input type="hidden" id="path" value="<?php echo site_url('') ?>">
                                <form  method="post" class="form-horizontal" action="<?php echo site_url("color/doSdataAdd")?>">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="colorname" placeholder="颜色名称" required>
                                            </div>
                                            <!-- /controls -->
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span3" id="remark" name="colorcode" placeholder="颜色代码" required>
                                            </div>
                                            <!-- /controls -->
                                        </div>
